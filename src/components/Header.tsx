...
import avatarImage from '@/images/zeilboot-icon.png'
...
function MobileNavigation(
  props: React.ComponentProps<typeof Popover['arguments']>
) {
  return (
    <Popover {...props}>
        ...
        >
          ...
          >
            <div className="flex flex-row-reverse items-center justify-between">
              ...
              <h2 className="text-sm font-medium text-zinc-600 ">Navigatie</h2>
            </div>
            <nav className="mt-6">
              <ul className="-my-2 divide-y divide-zinc-100 text-base text-zinc-800  ">
                <MobileNavItem href="/verantwoording">
                  Verantwoording
                </MobileNavItem>
                <MobileNavItem href="/artikelen">Artikelen</MobileNavItem>
              </ul>
            </nav>
          </Popover.Panel>
        </Transition.Child>
  ...
  return (
    <nav {...props}>
      <ul className="flex rounded-full bg-white/90 px-3 text-sm font-medium text-zinc-800 shadow-lg shadow-zinc-800/5 ring-1 ring-zinc-900/5 backdrop-blur">
        <NavItem href="/verantwoording">Verantwoording</NavItem>
        <NavItem href="/artikelen">Artikelen</NavItem>
      </ul>
    </nav>
  )
}
...
function Avatar({
  ...
  className,
  ...props
}: { large?: boolean } & Omit<React.ComponentProps<typeof Link>, 'href'>) {
  return (
    <Link
      href="/"
      aria-label="Home"
  ...
  useEffect(() => {
    ...
    function updateAvatarStyles() {
      ...
      setProperty(
        ...
        scale === toScale ? String(1) : String(0)
      )
    }
